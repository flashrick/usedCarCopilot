...
class VehicleProfileRecord(Base):
    ...
    transmission_detail: Mapped[str | None] = mapped_column(Text)
    transmission_maintenance_risk: Mapped[str | None] = mapped_column(Text)
    transmission_risk_note: Mapped[str | None] = mapped_column(Text)
    ...
    safety_rating_stars: Mapped[int | None] = mapped_column(Integer)
    safety_rating_source: Mapped[str | None] = mapped_column(Text)
    safety_rating_status: Mapped[str | None] = mapped_column(Text)
