...
const copy = {
  en: {
    ...
    findQuery: {
      ...
      selectionMinimumError: "Select at least 2 shortlisted listings before requesting AI advice.",
      selectionLimitError: "You can compare up to 4 shortlisted listings at a time.",
    ...
    searchResults: {
      ...
      emptyAdvice: "Select 2-4 shortlisted listings, then ask AI for a final recommendation and trade-off analysis.",
      ...
      aiAdvice: "AI Advice",
      aiAdviceTitle: "Final recommendation from your selected shortlist",
      selectedCount: "{count} shortlisted listings selected",
      selectionHint: "Choose 2-4 concrete listings from the shortlist, then request AI advice for the final decision.",
    ...
    adminWorkbench: {
      ...
      shortlistTitle: "Retrieve and choose the shortlist first",
      selectionHint: "Run retrieval, select 2-4 concrete listings, then call AI for the final recommendation.",
      selectedCount: "{count} listings selected",
      getAdvice: "Get AI advice",
      advising: "Generating advice...",
      emptyRecommendation: "Run retrieval, select 2-4 listings, then request AI advice to populate this panel.",
      selectionLimitError: "You can compare up to 4 shortlisted listings at a time.",
      selectionMinimumError: "Select at least 2 shortlisted listings before requesting AI advice.",
    },
    queryComposer: {
      eyebrow: "Decision Workbench",
      title: "Retrieve shortlist candidates before asking AI for a final recommendation.",
    ...
    adminCompare: {
      ...
      title: "Compare shortlisted listings with a second-stage AI recommendation.",
      description:
        "Run retrieval first, choose 2-4 concrete listings, then ask AI to rank them and explain the trade-offs side by side.",
  ...
  "zh-CN": {
    ...
    findQuery: {
      ...
      selectionMinimumError: "请先从候选清单中至少选择 2 台车，再请求 AI 建议。",
      selectionLimitError: "一次最多只能对比 4 台候选车。",
    ...
    searchResults: {
      ...
      emptyAdvice: "先从 shortlist 里选中 2-4 台具体车源，再请求 AI 生成最终建议和取舍分析。",
      emptyEvidence: "第二阶段 AI 建议完成后，这里会显示引用证据。",
      evidenceEyebrow: "证据引用",
      evidenceTitle: "推荐引擎使用了哪些证据",
      bestMatchBadge: "最佳匹配",
      aiAdvice: "AI 建议",
      aiAdviceTitle: "基于已选 shortlist 的最终建议",
      selectedCount: "已选择 {count} 台候选车",
      selectionHint: "先从 shortlist 中选 2-4 台具体车源，再请求 AI 给出最终判断。",
      getAdvice: "获取 AI 建议",
    ...
    adminWorkbench: {
      ...
      shortlistTitle: "先检索，再选择 shortlist",
      selectionHint: "先运行检索，再选择 2-4 台具体车源，最后调用 AI 生成最终建议。",
      selectedCount: "已选择 {count} 台车",
      getAdvice: "获取 AI 建议",
      advising: "正在生成建议...",
      emptyRecommendation: "先完成检索并选择 2-4 台车源，再请求 AI 建议。",
      selectionLimitError: "一次最多只能对比 4 台候选车。",
      selectionMinimumError: "请至少选择 2 台候选车后再请求 AI 建议。",
    },
    queryComposer: {
      eyebrow: "决策工作台",
      title: "先检索 shortlist，再让 AI 做最终推荐。",
      helper: "面向引用证据的分析师视图",
      need: "需求",
      placeholder: "I need a reliable car under $12,000 for commuting in Auckland.",
      budget: "预算",
