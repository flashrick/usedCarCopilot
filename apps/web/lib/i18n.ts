...
const copy = {
  en: {
    ...
    settings: {
      ...
      providerDescription: "Choose which AI provider powers `/recommend`, then edit the model and provider-specific connection settings below.",
  ...
  "zh-CN": {
    ...
    settings: {
      ...
      providerDescription: "先选择 `/recommend` 要使用的 AI 提供方，再在右侧填写该提供方对应的模型、API Key 和连接参数。",
