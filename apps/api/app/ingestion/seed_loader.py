            ...
            for row in vehicle_profiles:
                ...
                session.merge(
                    VehicleProfileRecord(
                        ...
                        transmission_detail=row.get("transmission_detail"),
                        transmission_maintenance_risk=row.get("transmission_maintenance_risk"),
                        transmission_risk_note=row.get("transmission_risk_note"),
                        drivetrain=row.get("drivetrain"),
                        fuel_type=row.get("fuel_type"),
                        body_type=row.get("body_type"),
                        seat_count=row.get("seat_count"),
                        safety_rating_stars=row.get("safety_rating_stars"),
                        safety_rating_source=row.get("safety_rating_source"),
                        safety_rating_status=row.get("safety_rating_status"),
